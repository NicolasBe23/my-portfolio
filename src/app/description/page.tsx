...
import { techLogos } from "@/constants/tech-logos";

export default function Description() {
  const { t } = useTranslation();

  return (
    <div className="flex flex-col items-center justify-center text-base md:text-lg gap-4 md:gap-10 mt-4 md:mt-6 w-full">
